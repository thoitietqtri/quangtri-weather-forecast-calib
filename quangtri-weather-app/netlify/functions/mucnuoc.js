...
// ============ 16 trạm VRain mực nước — toạ độ đã convert từ VN2000 (kinh
// tuyến trục chính thức tỉnh Quảng Trị 106°15' = 106.25°, false_easting=
// 500000, scale=0.9999 — ĐÃ SỬA từ lần đầu dùng nhầm kinh tuyến trục 105°
// khiến toạ độ lệch hẳn sang đất Lào) ============
const VRAIN_MUCNUOC_COORDS = {
  'Cam Tuyền': { lat: 16.77778, lng: 107.12027 },
  'Cây Da': { lat: 16.65222, lng: 107.31738 },
  'Bến Quan': { lat: 17.0173, lng: 106.909 },
  'Hàm Ninh': { lat: 17.35305, lng: 106.92361 },
  'Hải Tân': { lat: 16.83267, lng: 107.17605 },
  'Nam Thạch Hãn': { lat: 16.69444, lng: 107.14527 },
  'Quảng Thanh': { lat: 17.75444, lng: 106.64194 },
  'Triệu Đại': { lat: 16.8393, lng: 107.12941 },
  'Triệu Độ': { lat: 16.70097, lng: 107.29627 },
  'Lý Hòa': { lat: 17.63275, lng: 106.76605 },
  'Roòn': { lat: 17.89313, lng: 106.67433 },
  'Rào Nan': { lat: 17.76983, lng: 106.43847 },
  'Liên Trạch': { lat: 17.67866, lng: 106.6448 },
  'Vĩnh Phước': { lat: 17.01583, lng: 106.88669 },
  'Trúc Kinh': { lat: 16.87972, lng: 107.06361 },
  'Ái Tử': { lat: 16.76475, lng: 107.12988 },
};
