...
const VRAIN_MUCNUOC_COORDS = {
  ...
  'Cầu Bến Quan': { lat: 17.017347, lng: 106.909303 },
  'Hàm Ninh': { lat: 17.353189, lng: 106.673588 },
  'Hải Tân': { lat: 16.652225, lng: 107.317347 },
  'NQL vận hành hồ Nam Thạch Hãn': { lat: 16.694444, lng: 107.145278 },
  'Quảng Thanh': { lat: 17.754514, lng: 106.392017 },
  'Triệu Đại': { lat: 16.83263, lng: 107.176 },
  'Triệu Độ': { lat: 16.8392, lng: 107.12947 },
  'Trạm Thủy văn Lý Hòa': { lat: 17.632823, lng: 106.516056 },
  'Trạm Thủy văn Roòn': { lat: 17.893153, lng: 106.424542 },
  'Trạm Thủy văn Rào Nan': { lat: 17.769464, lng: 106.188409 },
  'Trạm thủy văn Liên Trạch': { lat: 17.6792, lng: 106.394843 },
  'Vĩnh Phước': { lat: 16.777778, lng: 107.120278 },
  'Đầu mối HCN Trúc Kinh': { lat: 16.879722, lng: 107.063611 },
  'Đầu mối HCN Ái Tử': { lat: 16.76475, lng: 107.129889 },
};
